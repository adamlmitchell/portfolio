...
.controller('MainController', ['$scope', function($scope) {
  ...
  $scope.timelineItems = [
    ...
    {
      type: 'project',
      title: "National Trust for Historic Preservation @Home Community",
			detail: "Elgg Community Build",
      location: 'Beaconfire RED',
